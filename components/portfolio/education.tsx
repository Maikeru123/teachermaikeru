...
export function Education() {
  return (
    <section id="education" className="section-frame bg-background px-6 py-12 sm:px-12 sm:py-14 lg:px-[4.5%]" aria-labelledby="education-heading">
      <h2 id="education-heading" className="text-[32px] font-semibold tracking-[-0.05em] sm:text-5xl">EDUCATION</h2>
      <article className="mt-8 flex flex-wrap items-start justify-between gap-6 border border-border bg-card p-6 shadow-[0_8px_18px_rgba(0,0,0,0.035)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.25)]">
      ...
      <article className="mt-4 flex flex-wrap items-start justify-between gap-6 border border-border bg-card p-6 shadow-[0_8px_18px_rgba(0,0,0,0.035)] dark:shadow-[0_8px_18px_rgba(0,0,0,0.25)]">
        <div className="flex items-start gap-4">
          <span className="inline-flex size-12 shrink-0 items-center justify-center rounded-full bg-zinc-950 text-white dark:bg-zinc-100 dark:text-zinc-950"><GraduationCap className="size-6" /></span>
          <div>
